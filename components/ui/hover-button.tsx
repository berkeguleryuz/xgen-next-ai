...
const options: ISourceOptions = {
  ...
  particles: {
    ...
    color: {
      value: ["#4d7c0f", "#84cc16", "#a3e635", "#d9f99d", "#bef264"],
    },
    shape: {
      type: "star",
      options: {
  ...
  return (
    <div
      ...
      <div className="relative flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-lime-500 via-lime-600 via-40% to-lime-500 px-8 py-2 text-white">
        ...
        <span className="font-semibold text-center mb-0.5">Choose your plan</span>
      </div>
      {!!particleState && (
        <Particles
          id="whatever"
          className={`pointer-events-none absolute -bottom-4 -left-4 -right-4 -top-4 z-0 opacity-0 transition-all duration-500 ease-in-out ${
